...
export default function SpecialtyHeartCare() {
...
const user = specialtyDoctor.find(item => item.specialty == "Heart Care");
let openingHours = "";
let phones = "";
...
if(user){
  ...
  return (
    ...
    <div className='specialtyCard'>
      <h4 className="text-center">Specialty Heart Care</h4>
    </div>

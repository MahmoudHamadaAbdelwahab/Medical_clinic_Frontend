...
export default function SpecialtyNeurology() {
...
const user = specialtyDoctor.find(item => item.specialty == "Neurology");
let openingHours = "";
let phones = "";
...
if(user){
  ...
  return (
    ...
    <div className='specialtyCard'>
      <h4 className="text-center">Specialty Neurology</h4>
    </div>

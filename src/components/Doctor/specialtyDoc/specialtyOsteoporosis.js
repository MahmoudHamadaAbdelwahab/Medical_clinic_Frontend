...
export default function SpecialtyOsteoporosis() {
...
const user = specialtyDoctor.find(item => item.specialty == "Osteoporosis");
let openingHours = "";
let phones = "";
  ...
  return (
    <div>
      <div className='specialtyCard'>
        <h4 className="text-center">Specialty Osteoporosis</h4>
      </div>

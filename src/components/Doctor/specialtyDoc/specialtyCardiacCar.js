...
export default function SpecialtyCardiacCar() {
 ...
 const user = specialtyDoctor.find(item => item.specialty == "Cardiac Car");
 let openingHours = "";
 let phones = "";
  ...
  return (
    <div>
      <div className='specialtyCard'>
        <h4 className="text-center">Specialty Cardiac Car</h4>
      </div>
